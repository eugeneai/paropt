...
CCCCCC ßÂÍÀß ÏĞÎÈÇÂÎÄÍÀß ÃÀÌÈËÜÒÎÍÈÀÍÀ ñ ÀËÜÔÀ ÏÎ v(t) - ñêàëÿğ
	 ...
	 pr=0.D0
	 do 1 i=1,n
1	  pr=pr+v1t(i) ! ÑÓÌÌÀ ÏÎ V1T(I=1,7)
...
CCCCCC ßÂÍÀß ÏĞÎÈÇÂÎÄÍÀß ÃÀÌÈËÜÒÎÍÈÀÍÀ ñ ÀËÜÔÀ ÏÎ st(t)
	e(1:m,1:m)=0.D0
	do 2 i=1,m
2	e(i,i)=1.D0
	dv=vt*d
...
CCCCCC ßÂÍÀß ÏĞÎÈÇÂÎÄÍÀß ÃÀÌÈËÜÒÎÍÈÀÍÀ ñ ÀËÜÔÀ ÏÎ u1(t)
...
CCCCCC ßÂÍÀß ÏĞÎÈÇÂÎÄÍÀß ÃÀÌÈËÜÒÎÍÈÀÍÀ ñ ÀËÜÔÀ ÏÎ u3(t) - ñêàëÿğ
...
CC	pr=sf0(38)*2.D0*u3t	! ÓÁÈĞÀÅÌ, ÁÓÄÅÌ ßÂÍÎ Ó×ÈÒÛÂÀÒÜ
c s0
c	hu3y=h1*psi2-r1(1,1)-alf*h1*(s0*b+(1.D0-s0)*pr)
c rk
C	hu3y=h1*psi2-r1(1,1)-alf*h1*(b+rk*pr/2.D0)
	hu3y=h1*psi2-h1*r1(1,1)-alf*h1*b ! ÁÅÇ ØÒĞÀÔÀ
...
CCCCCC ßÂÍÀß ÏĞÎÈÇÂÎÄÍÀß ÃÀÌÈËÜÒÎÍÈÀÍÀ ñ ÀËÜÔÀ ÏÎ u2(t) - âåêòîğ
